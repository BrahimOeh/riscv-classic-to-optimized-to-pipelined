...
//
//Brahim OUELD EL HAIRECH 2024-2025 , inspired from Bruno Levy, Matthias Koch
//****************************************************************

// Firmware generation flags for this processor
`define NRV_ARCH     "rv32i" //Base instruction set
`define NRV_ABI      "ilp32"
`define NRV_OPTIMIZE "-Os"  //optimization flag for command compilation flags
`define BENCH 1
...
`endif
   ...
   `ifdef BENCH
   	initial begin
		...
		registerFile[2] = 32'h00000800; //0x258 = 600 → 600/4 = 150 which is the memory case i want to point to in the memory
			for (i = 3; i < 32; i = i + 1)
